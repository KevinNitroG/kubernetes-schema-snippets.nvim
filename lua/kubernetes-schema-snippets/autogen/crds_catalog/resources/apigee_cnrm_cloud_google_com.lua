...
return function()
  return {
    ...
    t("apigeeendpointattachment_v1beta1"),
    t("apigeeenvgroup_v1alpha1"),
    t("apigeeenvgroup_v1beta1"),
    t("apigeeenvgroupattachment_v1alpha1"),
    t("apigeeenvgroupattachment_v1beta1"),
    t("apigeeenvironment_v1beta1"),
    t("apigeeinstance_v1alpha1"),
    t("apigeeinstance_v1beta1"),
    t("apigeeinstanceattachment_v1alpha1"),
    t("apigeeinstanceattachment_v1beta1"),
